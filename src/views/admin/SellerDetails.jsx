...
const SellerDetails = () => {
    return (
      ...
      <div className='w-full p-4 bg-slate-300 rounded-md shadow-xl shadow-slate-600 border-dashed border-2 border-black'>
    ...
    <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-[#9e97e9] rounded-md'>
        <div className='flex gap-2 font-bold text-[#000000]'>
            <span>Name : </span>
            <span>Kanye Kamat </span> 
        </div>
        <div className='flex gap-2 font-bold text-[#000000]'>
            <span>Email : </span>
            <span>ye@gmail.com </span> 
        </div>
        ...
        <div>
            <form>
                <div className='flex gap-4 py-3'>
                    <select className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#4cff23] border border-slate-700 rounded-md text-black font-semibold' name="" id="">
