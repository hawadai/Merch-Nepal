...
const ChatSeller = () => {
    ...
    <div className='px-2 lg:px-7 py-5'>
        <div className='w-full bg-[#1d1a41] px-4 py-4 rounded-md h-[calc(100vh-140px)]'>
    ...
    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
            ...
            <div className='bg-[#475569] h-[calc(100vh-290px)] rounded-md p-3 overflow-y-auto'>
                <div className='w-full flex justify-start items-center'>
                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                        ...
                        <div className='inline-flex self-center items-center p-2 text-sm font-medium text-center leading-1.5 border-gray-200 bg-gray-100 rounded-e-xl rounded-es-xl dark:bg-gray-700 text-white'>
                ...
                <div className='w-full flex justify-end items-center'>
                    <div className='flex justify-start items-start gap-2 md:px-3 py-2 max-w-full lg:max-w-[85%]'>
                        ...
                        <div className='flex justify-center items-start flex-col w-full shadow-lg shadow-blue-500/50 py-1 px-2 rounded-sm mr-2  bg-blue-400 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white'>
                        <span>How Are you ? </span>
                        </div> 
                        <div>
        ...
        <form className='flex gap-3'>
            <input className='border-2 bg-slate-600 w-full flex justify-between px-2 border-slate-700 items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]' type="text" placeholder='Input Your Message' />
            <button className='shadow-lg bg-[#4ae024] hover:shadow-lime-500/50 text-semibold w-[75px] h-[35px] rounded-md text-white flex justify-center items-center text-[25px]'><RiSendPlaneFill /></button>
